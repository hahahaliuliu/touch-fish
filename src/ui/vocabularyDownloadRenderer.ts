...
function getVocabularyText(language: InterfaceLanguage): VocabularyText {
  if (language === "chinese") {
    return {
      ...
      importPath: "词书文件路径",
      sharedControls: "操作  W/S 或上下方向键移动 | Esc 返回 | Q / Ctrl+C 退出程序",
      importControls: "操作  Enter 导入 | Backspace 删除 | Esc 取消编辑 | Ctrl+C 退出程序",
      ...
      importValidation: "文件会先校验，再复制到 Touch Fish 的本地词库；导入成功后可移动或删除原词书文件。",
      selectedBook: "当前词书",
      id: "编号",
      license: "许可证",
      pending: "待确认",
  ...
  return {
    ...
    sharedControls: "Controls  W/S or Up/Down move | Esc return | Q / Ctrl+C quit program",
    importControls: "Controls  Enter import | Backspace delete | Esc cancel edit | Ctrl+C quit program",
    ...
    importValidation: "The file is validated and copied into Touch Fish; after import, the original can be moved or deleted.",
